...
/* Za zadatak */
char char_a[8]  = {0b00000, 0b11111, 0b10001, 0b10001, 0b11111, 0b10001, 0b10001, 0b00000};
char char_b[8]  = {0b00000, 0b11111, 0b10000, 0b10000, 0b11111, 0b10001, 0b11111, 0b00000};
char char_v[8]  = {0b00000, 0b11111, 0b10001, 0b11110, 0b10001, 0b10001, 0b11111, 0b00000};
char char_d[8]  = {0b00000, 0b01110, 0b01010, 0b01010, 0b01010, 0b11111, 0b10001, 0b00000};
char char_dz[8] = {0b00000, 0b10001, 0b10001, 0b10001, 0b10001, 0b11111, 0b00100, 0b00000};
char char_c[8]  = {0b00000, 0b10010, 0b10010, 0b10010, 0b10010, 0b11111, 0b00001, 0b00000};
char char_sh[8] = {0b00000, 0b10101, 0b10101, 0b10101, 0b10101, 0b11111, 0b00000, 0b00000};
char char_zh[8] = {0b00000, 0b10101, 0b01110, 0b00100, 0b11111, 0b00100, 0b01110, 0b10101};
...
void volume(void)
{
    ...
    lcdCharDef (lcd, 0, char_a);
    lcdCharDef (lcd, 1, char_b);
    lcdCharDef (lcd, 2, char_c);
    lcdCharDef (lcd, 3, char_d);
    lcdCharDef (lcd, 4, char_dz);
    lcdCharDef (lcd, 5, char_sh);
    lcdCharDef (lcd, 6, char_v);
    lcdCharDef (lcd, 7, char_zh);
